...
namespace KeyReassigner.Infrastructure.External
{
    class WindowsLowLevelKeyboardHook
    {
        ...
        public struct INPUT
        {
            ...
            {
                this.type = 1;
                KEYBDINPUT keybdInput = new WindowsLowLevelKeyboardHook.KEYBDINPUT(wVk);
                this.U = new WindowsLowLevelKeyboardHook.InputUnion
                {
                    ki = keybdInput
                };
            }
